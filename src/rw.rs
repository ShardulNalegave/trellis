...
pub trait Reader: ReadPreReqs {
  async fn read_u8(&mut self) -> Result<u8> {
    let mut byts = BytesMut::with_capacity(1);
  ...
  async fn read_u16(&mut self) -> Result<u16> {
    let mut byts = BytesMut::with_capacity(2);
    self.read(&mut byts).await?;
  ...
  async fn read_u32(&mut self) -> Result<u32> {
    let mut byts = BytesMut::with_capacity(4);
    self.read(&mut byts).await?;
  ...
  async fn read_u64(&mut self) -> Result<u64> {
    let mut byts = BytesMut::with_capacity(8);
    self.read(&mut byts).await?;
  ...
  async fn read_u128(&mut self) -> Result<u128> {
    let mut byts = BytesMut::with_capacity(16);
    self.read(&mut byts).await?;
